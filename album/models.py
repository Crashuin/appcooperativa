...
class Oficinas(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('oficinas-list')

class Asociado(models.Model):
    oficina = models.ForeignKey('Oficinas', on_delete=models.PROTECT,related_name='get_oficinas')
...
class Aportes(models.Model):
    ...
    def __str__(self):
        return self.fecha + " " + self.valor
    
    def get_absolute_url(self):
        return reverse('aportes-list')